...
class LocalServerFacadeTest
{
    ...
    private LocalServerFacade localServerFacadeSpy;

    @BeforeEach
    void setup() {
        localServerFacadeSpy = Mockito.spy(new LocalServerFacade());
        ...
        Mockito.when(localServerFacadeSpy.getFollowGenerator()).thenReturn(mockFollowGenerator);
    }
    ...
    void testGetFollowees_noFolloweesForUser() {
        ...
        FollowingResponse response = localServerFacadeSpy.getFollowees(request);
    ...
    void testGetFollowees_limitLessThanUsers_endsOnPageBoundary() {
        ...
        response = localServerFacadeSpy.getFollowees(request);
