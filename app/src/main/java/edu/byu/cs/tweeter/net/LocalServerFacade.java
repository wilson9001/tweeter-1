...
public class LocalServerFacade
{
    ...
    public SignInResponse signIn(SignInRequest signInRequest)
    {
        ...
        else if (userPassword.equals(signInRequest.getPassword()))
        {
            ...
            if (signedInUser == null)
            {
                Log.e("LocalServerFacad signin", "aliasesToUsers did not contain alias even though aliasesToPasswords did");
            }

            Log.d("LocalServerFacad signIn", "SignIn successful");
            return new SignInResponse(signedInUser, null);
        }
        else
        {
    ...
    public SignUpResponse signUp(SignUpRequest signUpRequest)
    {
        ...
        if(aliasesToUsers.get("@".concat(userAlias)) == null)
        {
            ...
            return new SignUpResponse(newUser, null);
        }
        else
        {
    ...
    private Map<User, List<User>> initializeFollowers()
    {
        ...
        if (follows == null)
        {
            follows = getFollowGenerator().generateUsersAndFollows(50, 1, 25/*100, 0, 50*/, FollowGenerator.Sort.FOLLOWEE_FOLLOWER);
        }
    ...
    * */
    ...
    private Map<User, List<User>> initializeFollowees()
    {
        ...
        if (follows == null)
        {
            follows = getFollowGenerator().generateUsersAndFollows(50, 1, 25/*100, 1, 50*/, FollowGenerator.Sort.FOLLOWER_FOLLOWEE);
        }
