...
class ClientCommunicator
{
    ...
    <T> T doPut(String urlPath, final Object requestInfo, Map<String, String> headers, Class<T> returnType) throws IOException
    {
        RequestStrategy requestStrategy = new RequestStrategy()
        {
            ...
            public void sendRequest(HttpURLConnection connection) throws IOException
            {
                ...
                Log.d("doPut", "request body JSON: ".concat(entityBody));
    ...
    <T> T doPost(String urlPath, final Object requestInfo, Map<String, String> headers, Class<T> returnType) throws IOException
    {
        RequestStrategy requestStrategy = new RequestStrategy()
        {
            ...
            public void sendRequest(HttpURLConnection connection) throws IOException
            {
                ...
                Log.d("doPost", "request body JSON: ".concat(entityBody));
    ...
    {
        try (BufferedReader in = new BufferedReader(new InputStreamReader(connection.getResponseCode() < 400 ? connection.getInputStream() : connection.getErrorStream())))
        {
            ...
            Log.d("RawServerResponse", response.toString());
